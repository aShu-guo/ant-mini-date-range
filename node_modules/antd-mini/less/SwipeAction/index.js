        ...
        initWidth: function (func) {
            ...
            rightButtons.length > 0 && my.createSelectorQuery()
                ...
                if (ret && ret[0] && ret[0].width) {
                    _this.setData({ maxSwipeR: ret[0].width });
            ...
            leftButtons.length > 0 && my.createSelectorQuery()
                ...
                .exec(function (ret) {
                if (ret && ret[0] && ret[0].width) {
                    _this.setData({ maxSwipeL: ret[0].width });
                    func && func(ret[0].width);
                }
            });
        },
            ...
            this.setData({
                ...
                setTimeout(function () {
                    _this.setData({
                        ...
                        onSwipeEnd({ direction: 'left', swiped: !!isRight }, fmtEvent(_this.props));
                    });
            ...
            this.setData({
                ...
                setTimeout(function () {
                    _this.setData({
                        ...
                        onSwipeEnd({ direction: 'right', swiped: !!isRight }, fmtEvent(_this.props));
                    });
                }, inertiaWidth > 0 ? 180 : 0);
            });
        },
